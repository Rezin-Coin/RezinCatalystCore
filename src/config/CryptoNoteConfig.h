...
// Copyright (c) 2024, The RezinCatalystCore Team
//
...
namespace CryptoNote
{
  namespace parameters
  {
    ...
    /* Fee to charge per byte of transaction. Will be applied in chunks, see
       ...
       - 5 RZCC vs 5.12 RZCC. You can read this as.. the fee per chunk
    ...
    const uint64_t ACCEPTABLE_FEE                                          = UINT64_C(1000);     /* with this fee, tx is always accepted whatever size - 0.00000100 RZCC */
    const uint64_t ACCEPTABLE_FEE_V1                                       = UINT64_C(1000);     /* with this fee, tx is always accepted whatever size - 0.00000100 RZCC */
    ...
    /* 30,000,000 RZCC -> Max supply / mixin+1 outputs                 */
  ...
  const char LATEST_VERSION_URL[]                                          = "https://github.com/RezinCatalystCoreProject/RezinCatalystCore/releases";
