...
{
    j = {{"transactionHash", t.txHash}, {"txPrivateKey", t.txPrivateKey}};
}
...
std::vector<TxPrivateKey> txPrivateKeysToVector(const std::unordered_map<Crypto::Hash, Crypto::SecretKey> txPrivateKeys)
{
